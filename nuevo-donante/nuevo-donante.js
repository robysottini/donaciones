...
myApp.directive("nuevoDonante", function() {
    return {
...
myApp.controller("NuevoDonanteController", function($scope, $filter, $http) {
     ...
     * nuevo-donante.php y las guarda en el array rowFrecuenciasDeDonacion.
     */
