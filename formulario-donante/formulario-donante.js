...
myApp.controller("FormularioDonanteController", function($scope, $filter, $http) {
    ...
    $scope.persona = {
        per_fecha_nacimiento: "2000-01-01"
        /*
        dni: 33931635,
        nombre: "Elizabeth",
        apellido: "Ponce",
    ...
    $http.get("formulario-donante/formulario-donante.php?action=obtener-personas")
        .success(function(response) {
            ...
            $scope.persona.per_fecha_nacimiento = new Date("01-01-2000");
            console.log($scope.persona.per_fecha_nacimiento);
        }).
        error(function(data, status, headers, config) {
            console.log("Error en main.js > formulario-donante.php?action=obtener-personas. Status: " + status + ".");
    });
