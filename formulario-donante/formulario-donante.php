...
switch($_REQUEST['action']) {
    case 'obtener-personas':
        $sSQL = "
            SELECT 
                ...
                personas.per_fecha_nacimiento::DATE,
                personas.per_codigo_area,
                personas.per_telefono,
                personas.per_email,
                personas.per_direccion,
                personas.per_nota, 
                grupos_sanguineos.gru_id AS grupo_sanguineo, 
                frecuencias_donacion.fre_id AS frecuencia_donacion
    ...
    case 'modificar-persona':
        $persona = json_decode(file_get_contents("php://input"));
        echo $persona->per_nombre;
        $per_id = $persona->per_id;
        $per_nombre = $persona->per_nombre;
        $per_apellido = $persona->per_apellido;
        $per_dni = $persona->per_dni;
        echo $persona->per_fecha_nacimiento;
        $per_fecha_nacimiento = date_format($persona->per_fecha_nacimiento, "Y/m/d");
        echo $persona->per_fecha_nacimiento;
        ...
        $per_grupo_sanguineo = $persona->per_grupo_sanguineo;
